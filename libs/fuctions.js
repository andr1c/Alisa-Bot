...
if (user.level <= 3) {
 user.role = '🙊 NOVATO(A) :v'
  ...
  user.role = 'MAESTRO(A) IV ⚒️'
} else if (user.level <= 42) {
  user.role = 'MAESTRO(A) III ⚒️'
} else if (user.level <= 45) {
  user.role = 'MAESTRO(A) II ⚒️'
  ...
  user.role = 'ESTELAR II ☄️'
} else if (user.level <= 129) {
  user.role = 'ESTELAR I ☄️'
} else if (user.level <= 132) {
  user.role = 'TOP ASTRAL III ⚜️🔱'
} else if (user.level <= 135) {
  user.role = 'TOP ASTRAL II ⚜️🔱'
} else if (user.level <= 138) {
  user.role = 'TOP ASTRAL I ⚜️🔱'
} else if (user.level <= 141) {
  user.role = '👑 ÉLITE GLOBAL IV 🏁'
} else if (user.level <= 151) {
  user.role = '👑 ÉLITE GLOBAL III 🏁'
