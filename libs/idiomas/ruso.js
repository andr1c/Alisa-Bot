...
Больше команд, в будущих версиях я хочу добавить несколько собственных команд, напишите моему автору`, 
text17: `*🌐 ПРАВИЛА БОТА 🌐*
...
text8: `*[ БОТ В ТУ ГРУПО ]*

Вы можете запросить его, сделав добровольное пожертвование через Mercado Pago arg.

🚀 Бот будет активен для вашей группы 24/7.
 
*⚡ Где я могу сделать пожертвование?*
Через нашу платежную площадку.

❇️Платежный рынок:
• Псевдоним: elrebelde21
• CVU: 0000003100059201491917.

*⚡ Я не могу сделать пожертвование, есть ли другой вариант получить ботов для моей группы?*
Вы можете поддержать наш официальный репозиторий несколькими звездами 🌟
...
После оплаты вы можете уведомить моего создателя и отправить подтверждение денежного перевода (скриншот), чтобы я мог добавить бота в вашу группу 👇.
https://chat.whatsapp.com/BvElRVdgTVW34KRXtnvBfB

*⚡ Будет ли бот активен 24/7?*
Да, наш бот размещен на платных серверах, чтобы поддерживать его активность 24 часа в сутки, 7 дней в неделю (поэтому мы также просим пожертвования для его поддержания).`, 
text9: `*⚠️ и картинки?*`, 
