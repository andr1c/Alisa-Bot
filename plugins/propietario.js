...
async function owner5(conn, isCreator, quoted, text, command, m) {
if (!isCreator) return m.reply(info.owner) 
...
async function owner6(isCreator, conn, m) {
if (!isCreator) return m.reply(info.owner) 
...
async function owner7(isCreator, conn, m) {
if (!isCreator) return m.reply(info.owner) 
...
async function owner10(isCreator, m, text) {
if (!isCreator) return m.reply(info.owner) 
const pajak = 0;
let who;
...
async function owner11(isCreator, m, text) {
if (!isCreator) return m.reply(info.owner) 
const pajak = 0;
let who;
if (m.isGroup) who = m.mentionedJid[0];
...
module.exports = {owner1, owner2, owner3, owner4, owner5, owner6, owner7, owner8, owner9, owner10, owner11}
