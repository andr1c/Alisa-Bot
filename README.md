...
<a href="https://wa.me/59173315260" target="blank"><img src="https://img.shields.io/badge/Creador-25D366?style=for-the-badge&logo=whatsapp&logoColor=white" /></a>
...
```
```bash
git clone https://github.com/andr1c/NovaBot-MD/NovaBot-MD && cd NovaBot-MD && yarn && npm install
```
```bash
npm start
```
...
```bash
grep -q 'bash\|wget' <(dpkg -l) || apt install -y bash wget && wget -O - https://raw.githubusercontent.com/andr1c/NovaBot-MD/update.sh | bash
```
